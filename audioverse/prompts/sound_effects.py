class SoundEffectsPrompt:
    def __init__(self):
        ...
        These sound effects should be comprehensible even when taken out of context. They should be presented in the form of a noun and verb, such as "baby crying" or "door slamming."
